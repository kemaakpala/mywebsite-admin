...
const jumbotron = () => (
    <div className={classes.Jumbotron}>
        <div className={classes.JumbotronBlock}>
            ...
            <img className={classes.JumbotronImage} src={JumbotronImage} alt="imagename"/>
        </div>
    </div>
)
